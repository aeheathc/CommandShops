...
public class ShopCommandExecutor implements CommandExecutor
{
	...
	public boolean onCommand(CommandSender sender, Command command, String commandLabel, String[] args)
	{
		...
		{
			if(type.equalsIgnoreCase("search"))											cmd = new CommandShopSearch(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("find"))										cmd = new CommandShopFind(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("create"))									cmd = new CommandShopCreate(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("destroy"))									cmd = new CommandShopDestroy(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("move"))										cmd = new CommandShopMove(plugin, commandLabel, sender, cmdString);
			...
			else if(type.equalsIgnoreCase("list"))										cmd = new CommandShopList(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("info"))										cmd = new CommandShopInfo(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("version"))									cmd = new CommandShopVersion(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("reload"))									cmd = new CommandShopReload(plugin, commandLabel, sender, cmdString);
			else if(type.equalsIgnoreCase("log"))										cmd = new CommandShopLog(plugin, commandLabel, sender, cmdString);
			else																		cmd = new CommandShopHelp(plugin, commandLabel, sender, cmdString);
