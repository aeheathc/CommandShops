...
public class CommandShopHelp extends Command {
    ...
    public CommandShopHelp(CommandShops plugin, String commandLabel, CommandSender sender, String command) {
    ...
    public boolean process() {
        sender.sendMessage(CommandShops.CHAT_PREFIX + ChatColor.DARK_AQUA + "Here are the available commands [required] <optional>");
        ...
        if (canUseCommand(CommandTypes.BROWSE)) {
            sender.sendMessage(ChatColor.WHITE + "   /" + commandLabel + " browse <buy|sell|itemname> " + ChatColor.DARK_AQUA + "-List the shop's inventory");
        }
