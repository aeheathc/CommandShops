...
public class CommandShopDestroy extends Command {
    ...
    public CommandShopDestroy(CommandShops plugin, String commandLabel, CommandSender sender, String command) {
        ...
        if (plugin.getPlayerData().get(playerName).shopList.size() == 1) {
            ...
            while (it.hasNext()) {
                ...
                if (p.shopList.contains(shop.getUuid())) {
                    ...
                    thisPlayer.sendMessage(CommandShops.CHAT_PREFIX + ChatColor.WHITE + shop.getName() + ChatColor.DARK_AQUA + " has been destroyed");
                }
            }
