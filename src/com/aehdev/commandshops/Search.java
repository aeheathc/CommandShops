...
public class Search
{
	...
	public static void reload(CommandShops plugin)
	{
		...
		items.add(new ItemInfo("Grassless Dirt",	new String[][] {{"grassless"}},									3,	(short) 1, 64 ));
		items.add(new ItemInfo("Podzol",			new String[][] {{"podz"}},										3,	(short) 2, 64 ));
		items.add(new ItemInfo("Cobblestone",		new String[][] {{"cobb","sto"},{"cobb"}},						4,	(short) 0, 64 ));
		items.add(new ItemInfo("Oak Planks",		new String[][] {{"plank"},{"plank","oak"}},						5,	(short) 0, 64 ));
		...
		items.add(new ItemInfo("Oak Sapling",		new String[][] {{"sapling"},{"sapling","oak"}},					6,	(short) 0, 64 ));
		...
		items.add(new ItemInfo("Water Block",		new String[][] {{"water","blo"}},								9,	(short) 0, 64 ));
		items.add(new ItemInfo("Lava Block",		new String[][] {{"lava","blo"}},								11, (short) 0, 64 ));
		...
		items.add(new ItemInfo("Chiseled Sandstone",new String[][] {{"sand","st","chi"}},							24, (short) 1, 64 ));
		...
		items.add(new ItemInfo("Poppy",				new String[][] {{"rose"},{"poppy"}},							38, (short) 0, 64 ));
		items.add(new ItemInfo("Blue Orchid",		new String[][] {{"orchid"}},									38, (short) 1, 64 ));
		items.add(new ItemInfo("Allium",			new String[][] {{"alli"}},										38, (short) 2, 64 ));
		items.add(new ItemInfo("Azure Bluet",		new String[][] {{"bluet"}},										38, (short) 3, 64 ));
		items.add(new ItemInfo("Red Tulip",			new String[][] {{"tulip","red"}},								38, (short) 4, 64 ));
		items.add(new ItemInfo("Orange Tulip",		new String[][] {{"tulip","ora"}},								38, (short) 5, 64 ));
		items.add(new ItemInfo("White Tulip",		new String[][] {{"tulip","whi"}},								38, (short) 6, 64 ));
		items.add(new ItemInfo("Pink Tulip",		new String[][] {{"tulip","pin"}},								38, (short) 7, 64 ));
		items.add(new ItemInfo("Oxeye Daisy",		new String[][] {{"daisy"}},										38, (short) 8, 64 ));
	...
	items.add(new ItemInfo("Double Clay Brick Slab",new String[][] {{"dou","slab","bric","clay"}},					43, (short) 4, 64 ));
	...
	items.add(new ItemInfo("Double Quartz Tile Slab",new String[][]{{"dou","slab","quar","til"}},					43, (short) 10,64 ));
		...
		items.add(new ItemInfo("Clay Brick Slab",	new String[][] {{"slab","bric","clay"}},						44, (short) 4, 64 ));
		...
		items.add(new ItemInfo("Smooth Stone Slab",	new String[][] {{"slab","smo","sto"}},							44, (short) 8, 64 ));
		items.add(new ItemInfo("Smooth Sandstone Slab",new String[][]{{"slab","sand","smo"}},						44, (short) 9, 64 ));
		items.add(new ItemInfo("Quartz Tile Slab",	new String[][] {{"slab","quar","til"}},							44, (short) 10,64 ));
		items.add(new ItemInfo("Clay Brick Block",	new String[][] {{"clay","bric","bloc"}},						45, (short) 0, 64 ));
		...
		items.add(new ItemInfo("Rail",				new String[][] {{"rail"}},										66, (short) 0, 64 ));
		...
		items.add(new ItemInfo("Silverfish Stone",	new String[][] {{"silver","ston"}},								97, (short) 0, 64 ));
		items.add(new ItemInfo("Silverfish Cobblestone",new String[][]{{"silver","cob"},{"silver","cob","ston"}},	97, (short) 1, 64 ));
		items.add(new ItemInfo("Silverfish Stone Brick",new String[][]{{"silver","bric"},{"silver","ston","bric"}},	97, (short) 2, 64 ));
		items.add(new ItemInfo("Stone Brick Block",	new String[][] {{"ston","bric","bloc"}},						98, (short) 0, 64 ));
		items.add(new ItemInfo("Mossy Stone Brick Block",new String[][]{{"ston","bric","moss","bloc"}},				98, (short) 1, 64 ));
		items.add(new ItemInfo("Cracked Stone Brick Block",new String[][]{{"ston","bric","cra"}},					98, (short) 2, 64 ));
		items.add(new ItemInfo("Chiseled Stone Brick Block",new String[][] {{"ston","bric","chi"}},					98, (short) 3, 64 ));
		...
		items.add(new ItemInfo("Clay Brick Stairs",	new String[][] {{"clay","bric","stair"}},						108,(short) 0, 64 ));
		...
		items.add(new ItemInfo("Nether Brick Block",new String[][] {{"bric","nether","bloc"}},						112,(short) 0, 64 ));
		...
		items.add(new ItemInfo("White Stained Clay",new String[][] {{"clay","whit"}},								159,(short) 0, 64 ));
		items.add(new ItemInfo("Orange Stained Clay",new String[][]{{"clay","ora"}},								159,(short) 1, 64 ));
		items.add(new ItemInfo("Magenta Stained Clay",new String[][]{{"clay","mag"}},								159,(short) 2, 64 ));
		items.add(new ItemInfo("Light Blue Stained Clay",new String[][]{{"clay","lig","blue"}},						159,(short) 3, 64 ));
		items.add(new ItemInfo("Yellow Stained Clay",new String[][]{{"clay","yell"}},								159,(short) 4, 64 ));
		items.add(new ItemInfo("Lime Stained Clay",	new String[][] {{"clay","lime"}},								159,(short) 5, 64 ));
		items.add(new ItemInfo("Pink Stained Clay",	new String[][] {{"clay","pink"}},								159,(short) 6, 64 ));
		items.add(new ItemInfo("Gray Stained Clay",	new String[][] {{"clay","gray"},{"clay","grey"}},				159,(short) 7, 64 ));
		items.add(new ItemInfo("Light Gray Stained Clay",new String[][]{{"clay","gray","lig"},{"clay","grey","lig"}},159,(short)8, 64 ));
		items.add(new ItemInfo("Cyan Stained Clay",	new String[][] {{"clay","cya"}},								159,(short) 9, 64 ));
		items.add(new ItemInfo("Purple Stained Clay",new String[][]{{"clay","pur"}},								159,(short) 10,64 ));
		items.add(new ItemInfo("Blue Stained Clay",	new String[][] {{"clay","blue"}},								159,(short) 11,64 ));
		items.add(new ItemInfo("Brown Stained Clay",new String[][] {{"clay","brow"}},								159,(short) 12,64 ));
		items.add(new ItemInfo("Green Stained Clay",new String[][] {{"clay","gree"}},								159,(short) 13,64 ));
		items.add(new ItemInfo("Red Stained Clay",	new String[][] {{"clay","red"}},								159,(short) 14,64 ));
		items.add(new ItemInfo("Black Stained Clay",new String[][] {{"clay","bla"}},								159,(short) 15,64 ));
		items.add(new ItemInfo("Hay Block",			new String[][] {{"hay"}},										170,(short) 0, 64 ));
		items.add(new ItemInfo("White Carpet",		new String[][] {{"carp","whit"}},								171,(short) 0, 64 ));
		items.add(new ItemInfo("Orange Carpet",		new String[][] {{"carp","ora"}},								171,(short) 1, 64 ));
		items.add(new ItemInfo("Magenta Carpet",	new String[][] {{"carp","mag"}},								171,(short) 2, 64 ));
		items.add(new ItemInfo("Light Blue Carpet",	new String[][] {{"carp","lig","blue"}},							171,(short) 3, 64 ));
		items.add(new ItemInfo("Yellow Carpet",		new String[][] {{"carp","yell"}},								171,(short) 4, 64 ));
		items.add(new ItemInfo("Lime Carpet",		new String[][] {{"carp","lime"}},								171,(short) 5, 64 ));
		items.add(new ItemInfo("Pink Carpet",		new String[][] {{"carp","pink"}},								171,(short) 6, 64 ));
		items.add(new ItemInfo("Gray Carpet",		new String[][] {{"carp","gray"},{"carp","grey"}},				171,(short) 7, 64 ));
		items.add(new ItemInfo("Light Gray Carpet",	new String[][] {{"carp","gray","lig"},{"carp","grey","lig"}},	171,(short) 8, 64 ));
		items.add(new ItemInfo("Cyan Carpet",		new String[][] {{"carp","cya"}},								171,(short) 9, 64 ));
		items.add(new ItemInfo("Purple Carpet",		new String[][] {{"carp","pur"}},								171,(short) 10,64 ));
		items.add(new ItemInfo("Blue Carpet",		new String[][] {{"carp","blue"}},								171,(short) 11,64 ));
		items.add(new ItemInfo("Brown Carpet",		new String[][] {{"carp","brow"}},								171,(short) 12,64 ));
		items.add(new ItemInfo("Green Carpet",		new String[][] {{"carp","gree"}},								171,(short) 13,64 ));
		items.add(new ItemInfo("Red Carpet",		new String[][] {{"carp","red"}},								171,(short) 14,64 ));
		items.add(new ItemInfo("Black Carpet",		new String[][] {{"carp","bla"}},								171,(short) 15,64 ));
		items.add(new ItemInfo("Hardened Clay",		new String[][] {{"hard","clay"}},								172,(short) 0, 64 ));
		items.add(new ItemInfo("Coal Block",		new String[][] {{"coal","bl"}},									173,(short) 0, 64 ));
		...
		items.add(new ItemInfo("Enchanted Golden Apple",new String[][]{{"appl","go","ench"}},						322, (short) 1, 64));
...
items.add(new ItemInfo("Bootleg Potion of Regeneration",new String[][] {{"poti","boot","regen"}},					373, (short) 1, 64 ));
items.add(new ItemInfo("Bootleg Potion of Swiftness",	new String[][] {{"poti","boot","swif"}},					373, (short) 2, 64 ));
items.add(new ItemInfo("Bootleg Potion of Fire Resistance",new String[][]{{"poti","boot","fire","res"}},			373, (short) 3, 64 ));
items.add(new ItemInfo("Bootleg Potion of Poison",		new String[][] {{"poti","boot","poi"}},						373, (short) 4, 64 ));
items.add(new ItemInfo("Bootleg Potion of Healing",		new String[][] {{"poti","boot","heal"}},					373, (short) 5, 64 ));
items.add(new ItemInfo("Bootleg Potion of Night Vision",new String[][] {{"poti","boot","nigh"}},					373, (short) 6, 64 ));
items.add(new ItemInfo("Bootleg Clear Potion",			new String[][] {{"poti","boot","clear"}},					373, (short) 7, 64 ));
items.add(new ItemInfo("Bootleg Potion of Weakness",	new String[][] {{"poti","boot","weak"}},					373, (short) 8, 64 ));
items.add(new ItemInfo("Bootleg Potion of Strength",	new String[][] {{"poti","boot","stre"}},					373, (short) 9, 64 ));
items.add(new ItemInfo("Bootleg Potion of Slowness",	new String[][] {{"poti","boot","slow"}},					373, (short) 10,64 ));
items.add(new ItemInfo("Bootleg Diffuse Potion",		new String[][] {{"poti","boot","diff"}},					373, (short) 11,64 ));
items.add(new ItemInfo("Bootleg Potion of Harming",		new String[][] {{"poti","boot","har"}},						373, (short) 12,64 ));
items.add(new ItemInfo("Bootleg Artless Potion",		new String[][] {{"poti","boot","artl"}},					373, (short) 13,64 ));
items.add(new ItemInfo("Bootleg Potion of Invisibility",new String[][] {{"poti","boot","invi"}},					373, (short) 14,64 ));
items.add(new ItemInfo("Bootleg Thin Potion",			new String[][] {{"poti","boot","thin"}},					373, (short) 15,64 ));
items.add(new ItemInfo("Awkward Potion",				new String[][] {{"poti","awk"}},							373, (short) 16,64 ));
items.add(new ItemInfo("Bootleg Potion of Regeneration 2",new String[][] {{"poti","boot","regen","2"}},				373, (short) 17,64 ));
items.add(new ItemInfo("Bootleg Potion of Swiftness 2",	new String[][] {{"poti","boot","swif","2"}},				373, (short) 18,64 ));
items.add(new ItemInfo("Bootleg Potion of Fire Resistance 2",new String[][] {{"poti","boot","fire","res","2"}},		373, (short) 19,64 ));
items.add(new ItemInfo("Bootleg Potion of Poison 2",	new String[][] {{"poti","boot","poi","2"}},					373, (short) 20,64 ));
items.add(new ItemInfo("Bootleg Potion of Healing 2",	new String[][] {{"poti","boot","heal","2"}},				373, (short) 21,64 ));
items.add(new ItemInfo("Bootleg Potion of Night Vision 2",new String[][] {{"poti","boot","clear","2"}},				373, (short) 22,64 ));
items.add(new ItemInfo("Bungling Potion",				new String[][] {{"poti","bung"}},							373, (short) 23,64 ));
items.add(new ItemInfo("Bootleg Potion of Weakness 2",	new String[][] {{"poti","boot","weak","2"}},				373, (short) 24,64 ));
items.add(new ItemInfo("Bootleg Potion of Strength 2",	new String[][] {{"poti","boot","stre","2"}},				373, (short) 25,64 ));
items.add(new ItemInfo("Bootleg Potion of Slowness 2",	new String[][] {{"poti","boot","slow","2"}},				373, (short) 26,64 ));
items.add(new ItemInfo("Smooth Potion",					new String[][] {{"poti","smoo"}},							373, (short) 27,64 ));
items.add(new ItemInfo("Bootleg Potion of Harming 2",	new String[][] {{"poti","boot","har","2"}},					373, (short) 28,64 ));
items.add(new ItemInfo("Suave Potion",					new String[][] {{"poti","suav"}},							373, (short) 29,64 ));
items.add(new ItemInfo("Bootleg Potion of Invisibility 2",new String[][] {{"poti","boot","invi","2"}},				373, (short) 30,64 ));
items.add(new ItemInfo("Debonair Potion",				new String[][] {{"poti","debo"}},							373, (short) 31,64 ));
items.add(new ItemInfo("Thick Potion",					new String[][] {{"poti","thick"}},							373, (short) 32,64 ));
items.add(new ItemInfo("Bootleg Potion of Regeneration 3",new String[][] {{"poti","boot","regen","3"}},				373, (short) 33,64 ));
items.add(new ItemInfo("Bootleg Potion of Swiftness 3",	new String[][] {{"poti","boot","swif","3"}},				373, (short) 34,64 ));
items.add(new ItemInfo("Bootleg Potion of Fire Resistance 3",new String[][] {{"poti","boot","fire","res","3"}},		373, (short) 35,64 ));
items.add(new ItemInfo("Bootleg Potion of Poison 3",	new String[][] {{"poti","boot","poi","3"}},					373, (short) 36,64 ));
items.add(new ItemInfo("Bootleg Potion of Healing 3",	new String[][] {{"poti","boot","heal","3"}},				373, (short) 37,64 ));
items.add(new ItemInfo("Bootleg Potion of Night Vision 3",new String[][] {{"poti","boot","clear","3"}},				373, (short) 38,64 ));
items.add(new ItemInfo("Charming Potion",				new String[][] {{"poti","char"}},							373, (short) 39,64 ));
items.add(new ItemInfo("Bootleg Potion of Weakness 3",	new String[][] {{"poti","boot","weak","3"}},				373, (short) 40,64 ));
items.add(new ItemInfo("Bootleg Potion of Strength 3",	new String[][] {{"poti","boot","stre","3"}},				373, (short) 41,64 ));
items.add(new ItemInfo("Bootleg Potion of Slowness 3",	new String[][] {{"poti","boot","slow","3"}},				373, (short) 42,64 ));
items.add(new ItemInfo("Refined Potion",				new String[][] {{"poti","refi"}},							373, (short) 43,64 ));
items.add(new ItemInfo("Bootleg Potion of Harming 3",	new String[][] {{"poti","boot","har","3"}},					373, (short) 44,64 ));
items.add(new ItemInfo("Cordial Potion",				new String[][] {{"poti","cord"}},							373, (short) 45,64 ));
items.add(new ItemInfo("Bootleg Potion of Invisibility 3",new String[][] {{"poti","boot","invi","3"}},				373, (short) 46,64 ));
items.add(new ItemInfo("Sparkling Potion",				new String[][] {{"poti","spar"}},							373, (short) 47,64 ));
items.add(new ItemInfo("Potent Potion",					new String[][] {{"poti","cord"}},							373, (short) 48,64 ));
items.add(new ItemInfo("Bootleg Potion of Regeneration 4",new String[][] {{"poti","boot","regen","4"}},				373, (short) 49,64 ));
items.add(new ItemInfo("Bootleg Potion of Swiftness 4",	new String[][] {{"poti","boot","swif","4"}},				373, (short) 50,64 ));
items.add(new ItemInfo("Bootleg Potion of Fire Resistance 4",new String[][] {{"poti","boot","fire","res","4"}},		373, (short) 51,64 ));
items.add(new ItemInfo("Bootleg Potion of Poison 4",	new String[][] {{"poti","boot","poi","4"}},					373, (short) 52,64 ));
items.add(new ItemInfo("Bootleg Potion of Healing 4",	new String[][] {{"poti","boot","heal","4"}},				373, (short) 53,64 ));
items.add(new ItemInfo("Bootleg Potion of Night Vision 4",new String[][] {{"poti","boot","clear","4"}},				373, (short) 54,64 ));
items.add(new ItemInfo("Rank Potion",					new String[][] {{"poti","rank"}},							373, (short) 55,64 ));
items.add(new ItemInfo("Bootleg Potion of Weakness 4",	new String[][] {{"poti","boot","weak","4"}},				373, (short) 56,64 ));
items.add(new ItemInfo("Bootleg Potion of Strength 4",	new String[][] {{"poti","boot","stre","4"}},				373, (short) 57,64 ));
items.add(new ItemInfo("Bootleg Potion of Slowness 4",	new String[][] {{"poti","boot","slow","4"}},				373, (short) 58,64 ));
items.add(new ItemInfo("Acrid Potion",					new String[][] {{"poti","acri"}},							373, (short) 59,64 ));
items.add(new ItemInfo("Bootleg Potion of Harming 4",	new String[][] {{"poti","boot","har","4"}},					373, (short) 60,64 ));
items.add(new ItemInfo("Gross Potion",					new String[][] {{"poti","gros"}},							373, (short) 61,64 ));
items.add(new ItemInfo("Bootleg Potion of Invisibility 4",new String[][] {{"poti","boot","invi","4"}},				373, (short) 62,64 ));
items.add(new ItemInfo("Stinky Potion",					new String[][] {{"poti","stin"}},							373, (short) 63,64 ));
items.add(new ItemInfo("Mundane Potion",				new String[][] {{"poti","mun"}},							373, (short)8192,64));
items.add(new ItemInfo("Potion of Regeneration",		new String[][] {{"poti","regen"}},							373, (short)8193,64));
items.add(new ItemInfo("Potion of Regeneration (extended)",new String[][]{{"poti","regen","ext"}},					373, (short)8257,64));
items.add(new ItemInfo("Potion of Regeneration 2",		new String[][] {{"poti","regen","2"}},						373, (short)8225,64));
items.add(new ItemInfo("Potion of Swiftness",			new String[][] {{"poti","swif"}},							373, (short)8194,64));
items.add(new ItemInfo("Potion of Swiftness (extended)",new String[][] {{"poti","swif","ext"}},						373, (short)8258,64));
items.add(new ItemInfo("Potion of Swiftness 2",			new String[][] {{"poti","swif","2"}},						373, (short)8226,64));
items.add(new ItemInfo("Potion of Fire Resistance",		new String[][] {{"poti","fire","res"}},						373, (short)8195,64));
items.add(new ItemInfo("Potion of Fire Resistance (extended)",new String[][]{{"poti","fire","res","ext"}},			373, (short)8259,64));
items.add(new ItemInfo("Potion of Healing",				new String[][] {{"poti","heal"}},							373, (short)8197,64));
items.add(new ItemInfo("Potion of Healing 2",			new String[][] {{"poti","heal","2"}},						373, (short)8229,64));
items.add(new ItemInfo("Potion of Strength",			new String[][] {{"poti","stre"}},							373, (short)8201,64));
items.add(new ItemInfo("Potion of Strength (extended)",	new String[][] {{"poti","stre","ext"}},						373, (short)8265,64));
items.add(new ItemInfo("Potion of Strength 2",			new String[][] {{"poti","stre","2"}},						373, (short)8233,64));
items.add(new ItemInfo("Potion of Poison",				new String[][] {{"poti","poi"}},							373, (short)8196,64));
items.add(new ItemInfo("Potion of Poison (extended)",	new String[][] {{"poti","poi","ext"}},						373, (short)8260,64));
items.add(new ItemInfo("Potion of Poison 2",			new String[][] {{"poti","poi","2"}},						373, (short)8228,64));
items.add(new ItemInfo("Potion of Weakness",			new String[][] {{"poti","weak"}},							373, (short)8200,64));
items.add(new ItemInfo("Potion of Weakness (extended)",	new String[][] {{"poti","weak","ext"}},						373, (short)8264,64));
items.add(new ItemInfo("Potion of Slowness",			new String[][] {{"poti","slow"}},							373, (short)8202,64));
items.add(new ItemInfo("Potion of Slowness (extended)",	new String[][] {{"poti","slow","ext"}},						373, (short)8266,64));
items.add(new ItemInfo("Potion of Harming",				new String[][] {{"poti","har"}},							373, (short)8204,64));
items.add(new ItemInfo("Potion of Harming 2",			new String[][] {{"poti","har","2"}},						373, (short)8236,64));
items.add(new ItemInfo("Splash Mundane Potion",			new String[][] {{"poti","spl","mun"}},						373,(short)16384,64));
items.add(new ItemInfo("Splash Potion of Regeneration",	new String[][] {{"poti","spl","regen"}},					373,(short)16385,64));
items.add(new ItemInfo("Splash Potion of Regeneration (extended)",new String[][]{{"poti","spl","regen","ext"}},		373,(short)16449,64));
items.add(new ItemInfo("Splash Potion of Regeneration 2",new String[][]{{"poti","spl","reg","2"}},					373,(short)16417,64));
items.add(new ItemInfo("Splash Potion of Swiftness",	new String[][] {{"poti","spl","swif"}},						373,(short)16386,64));
items.add(new ItemInfo("Splash Potion of Swiftness (extended)",new String[][]{{"poti","spl","swif","ext"}},			373,(short)16450,64));
items.add(new ItemInfo("Splash Potion of Swiftness 2",	new String[][] {{"poti","spl","swif","2"}},					373,(short)16418,64));
items.add(new ItemInfo("Splash Potion of Fire Resistance",new String[][]{{"poti","spl","fire","res"}},				373,(short)16387,64));
items.add(new ItemInfo("Splash Potion of Fire Resistance (extended)",new String[][]{{"poti","spl","fire","res","ext"}},373,(short)16451,64));
items.add(new ItemInfo("Splash Potion of Healing",		new String[][] {{"poti","spl","heal"}},						373,(short)16389,64));
items.add(new ItemInfo("Splash Potion of Healing 2",	new String[][] {{"poti","spl","heal","2"}},					373,(short)16421,64));
items.add(new ItemInfo("Splash Potion of Strength",		new String[][] {{"poti","spl","stre"}},						373,(short)16393,64));
items.add(new ItemInfo("Splash Potion of Strength (extended)",new String[][]{{"poti","spl","stre","ext"}},			373,(short)16457,64));
items.add(new ItemInfo("Splash Potion of Strength 2",	new String[][] {{"poti","spl","stre","2"}},					373,(short)16425,64));
items.add(new ItemInfo("Splash Potion of Poison",		new String[][] {{"poti","spl","poi"}},						373,(short)16388,64));
items.add(new ItemInfo("Splash Potion of Poison (extended)",new String[][]{{"poti","spl","poi","ext"}},				373,(short)16452,64));
items.add(new ItemInfo("Splash Potion of Poison 2",		new String[][] {{"poti","spl","poi","2"}},					373,(short)16420,64));
items.add(new ItemInfo("Splash Potion of Weakness",		new String[][] {{"poti","spl","weak"}},						373,(short)16392,64));
items.add(new ItemInfo("Splash Potion of Weakness (extended)",new String[][]{{"poti","spl","weak","ext"}},			373,(short)16456,64));
items.add(new ItemInfo("Splash Potion of Slowness",		new String[][] {{"poti","spl","slow"}},						373,(short)16394,64));
items.add(new ItemInfo("Splash Potion of Slowness (extended)",new String[][]{{"poti","spl","slow","ext"}},			373,(short)16458,64));
items.add(new ItemInfo("Splash Potion of Harming",		new String[][] {{"poti","spl","har"}},						373,(short)16396,64));
items.add(new ItemInfo("Splash Potion of Harming 2",	new String[][] {{"poti","spl","har","2"}},					373,(short)16428,64));
		...
		items.add(new ItemInfo("XP Egg",			new String[][] {{"egg","xp"}},									383, (short) 2, 64));
		items.add(new ItemInfo("Painting Egg",		new String[][] {{"egg","paint"}},								383, (short) 9, 64));
		items.add(new ItemInfo("Item Frame Egg",	new String[][] {{"egg","frame"}},								383, (short)18, 64));
		items.add(new ItemInfo("Primed TNT Egg",	new String[][] {{"egg","tnt"}},									383, (short)20, 64));
		items.add(new ItemInfo("Boat Egg",			new String[][] {{"egg","boat"}},								383, (short)41, 64));
		items.add(new ItemInfo("Minecart Egg",		new String[][] {{"egg","cart"}},								383, (short)42, 64));
		items.add(new ItemInfo("Chest Minecart Egg",new String[][] {{"egg","chest","cart"}},						383, (short)43, 64));
		items.add(new ItemInfo("Furnace Minecart Egg",new String[][]{{"egg","furn","cart"}},						383, (short)44, 64));
		items.add(new ItemInfo("TNT Minecart Egg",	new String[][] {{"egg","tnt","cart"}},							383, (short)45, 64));
		items.add(new ItemInfo("Hopper Minecart Egg",new String[][]{{"egg","hopp","cart"}},							383, (short)46, 64));
		items.add(new ItemInfo("Spawner Minecart Egg",new String[][]{{"egg","cart","egg"}},							383, (short)47, 64));
		items.add(new ItemInfo("Creeper Egg",		new String[][] {{"egg","cree"}},								383, (short)50, 64));
		items.add(new ItemInfo("Skeleton Egg",		new String[][] {{"egg","skel"}},								383, (short)51, 64));
		items.add(new ItemInfo("Spider Egg",		new String[][] {{"egg","spid"}},								383, (short)52, 64));
		items.add(new ItemInfo("Giant Egg",			new String[][] {{"egg","gian"}},								383, (short)53, 64));
		items.add(new ItemInfo("Zombie Egg",		new String[][] {{"egg","zom"}},									383, (short)54, 64));
		items.add(new ItemInfo("Slime Egg",			new String[][] {{"egg","slim"}},								383, (short)55, 64));
		items.add(new ItemInfo("Ghast Egg",			new String[][] {{"egg","ghas"}},								383, (short)56, 64));
		items.add(new ItemInfo("Zombie Pigman Egg",	new String[][]{{"egg","pigman"}},								383, (short)57, 64));
		items.add(new ItemInfo("Enderman Egg",		new String[][] {{"egg","end"}},									383, (short)58, 64));
		items.add(new ItemInfo("Cave Spider Egg",	new String[][]{{"egg","cav"}},									383, (short)59, 64));
		items.add(new ItemInfo("Silverfish Egg",	new String[][]{{"egg","silv"}},									383, (short)60, 64));
		items.add(new ItemInfo("Blaze Egg",			new String[][] {{"egg","blaz"}},								383, (short)61, 64));
		items.add(new ItemInfo("Magma Cube Egg",	new String[][]{{"egg","mag"}},									383, (short)62, 64));
		items.add(new ItemInfo("Ender Dragon Egg",	new String[][]{{"egg","dragon"}},								383, (short)63, 64));
		items.add(new ItemInfo("Wither Egg",		new String[][] {{"egg","with"}},								383, (short)64, 64));
		items.add(new ItemInfo("Bat Egg",			new String[][] {{"egg","bat"}},									383, (short)65, 64));
		items.add(new ItemInfo("Witch Egg",			new String[][] {{"egg","witc"}},								383, (short)66, 64));
		items.add(new ItemInfo("Pig Egg",			new String[][] {{"egg","pig"}},									383, (short)90, 64));
		items.add(new ItemInfo("Sheep Egg",			new String[][] {{"egg","she"}},									383, (short)91, 64));
		items.add(new ItemInfo("Cow Egg",			new String[][] {{"egg","cow"}},									383, (short)92, 64));
		items.add(new ItemInfo("Chicken Egg",		new String[][] {{"egg","chi"}},									383, (short)93, 64));
		items.add(new ItemInfo("Squid Egg",			new String[][] {{"egg","squ"}},									383, (short)94, 64));
		items.add(new ItemInfo("Wolf Egg",			new String[][] {{"egg","wolf"}},								383, (short)95, 64));
		items.add(new ItemInfo("Mooshroom Egg",		new String[][]{{"egg","moo"}},									383, (short)96, 64));
		items.add(new ItemInfo("Snow Golem Egg",	new String[][]{{"egg","snow"}},									383, (short)97, 64));
		items.add(new ItemInfo("Ocelot Egg",		new String[][] {{"egg","ocel"}},								383, (short)98, 64));
		items.add(new ItemInfo("Iron Golem Egg",	new String[][]{{"egg","iron"}},									383, (short)99, 64));
		items.add(new ItemInfo("Horse Egg",			new String[][] {{"egg","hors"}},								383, (short)100,64));
		items.add(new ItemInfo("Villager Egg",		new String[][] {{"egg","vil"}},									383, (short)120,64));
		items.add(new ItemInfo("Ender Crystal Egg",	new String[][]{{"egg","cry"}},									383, (short)200,64));
		...
		items.add(new ItemInfo("Empty Map",			new String[][] {{"map","blank"},{"map","empty"}},				395, (short) 0, 64));
		items.add(new ItemInfo("Golden Carrot",		new String[][] {{"gold","carrot"}},								396, (short) 0, 64));
		items.add(new ItemInfo("Skeleton Head",		new String[][] {{"head","skel"}},								397, (short) 0, 64));
		items.add(new ItemInfo("Wither Skeleton Head",new String[][]{{"head","skel","with"}},						397, (short) 1, 64));
		items.add(new ItemInfo("Zombie Head",		new String[][] {{"head","zom"}},								397, (short) 2, 64));
		items.add(new ItemInfo("Human Head",		new String[][] {{"head","hum"}},								397, (short) 3, 64));
		items.add(new ItemInfo("Creeper Head",		new String[][] {{"head","cre"}},								397, (short) 4, 64));
		...
		items.add(new ItemInfo("Iron Horse Armor",	new String[][] {{"iron","hors"}},								417, (short) 0, 1 ));
		items.add(new ItemInfo("Gold Horse Armor",	new String[][] {{"gol","hors"}},								418, (short) 0, 1 ));
		items.add(new ItemInfo("Diamond Horse Armor",new String[][]{{"dia","hors"}},								419, (short) 0, 1 ));
		items.add(new ItemInfo("Lead",				new String[][] {{"lead","leash"}},								420, (short) 0, 64));
		items.add(new ItemInfo("Name Tag",			new String[][] {{"lead","leash"}},								421, (short) 0, 64));
		...
		items.add(new ItemInfo("Wait Disc",			new String[][] {{"dis","wai"}},									2267,(short) 0, 1 ));
