...
public class Search
{
	...
	static
	{
		...
		items.add(new ItemInfo("Redwood Planks",	new String[][] {{"plank","red"}},								5,	(short) 1, 64 ));
		...
		items.add(new ItemInfo("Leaves",			new String[][] {{"lea"},{"lea","oak"}},							18, (short) 4, 64 ));
		items.add(new ItemInfo("Redwood Leaves",	new String[][] {{"lea","red"}},									18, (short) 5, 64 ));
		...
		items.add(new ItemInfo("Carved Sandstone",	new String[][] {{"sand","st","car"},{"sand","st","cre"}},		24, (short) 1, 64 ));
...
items.add(new ItemInfo("Hidden Silverfish Stone Brick",new String[][]{{"silver","bric"},{"hidden","silver","bric"},{"silver","ston","bric"},{"hidden","silver","ston","bric"}},	97, (short) 2, 64 ));
		...
		items.add(new ItemInfo("Circle Stone Brick",new String[][] {{"ston","bric","cir"}},							98, (short) 3, 64 ));
