...
items.add(new ItemInfo("Splash Potion of Harming 2",	new String[][] {{"poti","spl","har","2"}},					373,(short)16428,64));
		...
		items.add(new ItemInfo("Painting Egg",		new String[][] {{"paint","egg"}},								383, (short) 9, 64));
		items.add(new ItemInfo("Item Frame Egg",	new String[][] {{"frame","egg"}},								383, (short)18, 64));
		...
		items.add(new ItemInfo("Minecart Egg",		new String[][] {{"cart","egg"}},								383, (short)42, 64));
		items.add(new ItemInfo("Chest Minecart Egg",new String[][] {{"chest","cart","egg"}},						383, (short)43, 64));
		items.add(new ItemInfo("Furnace Minecart Egg",new String[][]{{"furn","cart","egg"}},						383, (short)44, 64));
		items.add(new ItemInfo("TNT Minecart Egg",	new String[][] {{"tnt","cart","egg"}},							383, (short)45, 64));
		items.add(new ItemInfo("Hopper Minecart Egg",new String[][]{{"hopp","cart","egg"}},							383, (short)46, 64));
		items.add(new ItemInfo("Spawner Minecart Egg",new String[][]{{"spawn","cart","egg"}},						383, (short)47, 64));
		...
		items.add(new ItemInfo("Giant Spawn Egg",	new String[][] {{"spawn","gian"}},								383, (short)53, 64));
		...
		items.add(new ItemInfo("Horse Spawn Egg",	new String[][] {{"spawn","hors"}},								383, (short)100,64));
