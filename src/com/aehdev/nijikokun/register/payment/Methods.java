...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.aehdev.nijikokun.register.payment.methods.iCo6());
        addMethod("iConomy", new com.aehdev.nijikokun.register.payment.methods.iCo5());
        addMethod("iConomy", new com.aehdev.nijikokun.register.payment.methods.iCo4());
        addMethod("BOSEconomy", new com.aehdev.nijikokun.register.payment.methods.BOSE6());
        addMethod("BOSEconomy", new com.aehdev.nijikokun.register.payment.methods.BOSE7());
        addMethod("Essentials", new com.aehdev.nijikokun.register.payment.methods.EE17());
        addMethod("Currency", new com.aehdev.nijikokun.register.payment.methods.MCUR());
