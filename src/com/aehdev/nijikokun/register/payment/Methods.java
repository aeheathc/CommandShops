 ...
 * interface based on a "first come, first served" basis. Allowing you to check
 * whether a payment method exists or not. Methods also allows you to set a
 * preferred method of payment before it captures payment plugins in the
 * initialization process. in <code>bukkit.yml</code>: <blockquote>
 * 
 * <pre>
 *  economy:
 *      preferred: "iConomy"
...
public class Methods
{
	...
	{
		addMethod("iConomy",
				new com.aehdev.nijikokun.register.payment.methods.iCo6());
		addMethod("iConomy",
				new com.aehdev.nijikokun.register.payment.methods.iCo5());
		addMethod("iConomy",
				new com.aehdev.nijikokun.register.payment.methods.iCo4());
		addMethod("BOSEconomy",
				new com.aehdev.nijikokun.register.payment.methods.BOSE6());
		addMethod("BOSEconomy",
				new com.aehdev.nijikokun.register.payment.methods.BOSE7());
		addMethod("Essentials",
				new com.aehdev.nijikokun.register.payment.methods.EE17());
		addMethod("Currency",
				new com.aehdev.nijikokun.register.payment.methods.MCUR());
	 ...
	 * @return - Array of payment methods that are loaded.
			...
			do
			{
				...
				else
				{
					for(Method attached: Attachables)
					{
						...
						if(count == 0) if(preferred.equalsIgnoreCase(attached
								.getName())) Method = attached;
