...
public class Search {
    ...
    static {
     ...
     // Unlimited = Unlimited (64) stack sizes for all items that wouldn't glitch as a result of it.
        ...
        items.add(new ItemInfo("White Wool", new String[][] { { "wool" }, { "wool", "whit" } }, 35, (short) 0, new int[]{ 64, 64, 64 } ));
        ...
        items.add(new ItemInfo("Light Blue Wool", new String[][] { { "wool", "blue" }, { "wool", "lig", "blue" } }, 35, (short) 3, new int[]{ 64, 64, 64 } ));
        items.add(new ItemInfo("Yellow Wool", new String[][] { { "wool", "yell" } }, 35, (short) 4, new int[]{ 64, 64, 64 } ));
        items.add(new ItemInfo("Light Green Wool", new String[][] { { "wool", "gree" }, { "wool", "lig", "gree" } }, 35, (short) 5, new int[]{ 64, 64, 64 } ));
        ...
        items.add(new ItemInfo("Light Gray Wool", new String[][] { { "lig", "wool", "gra" } }, 35, (short) 8, new int[]{ 64, 64, 64 } ));
        ...
        items.add(new ItemInfo("Dark Green Wool", new String[][] { { "wool", "gree" }, { "wool", "dar", "gree" } }, 35, (short) 13, new int[]{ 64, 64, 64 } ));
        ...
        items.add(new ItemInfo("Dangelion Yellow", new String[][] { { "dye", "yel" }, { "pet", "dan" }, { "pet", "yel" } }, 351, (short) 11, new int[]{ 64, 64, 64 } ));
